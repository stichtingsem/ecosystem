...
| OA.5.6 | N.A. | N.A. | The User uses the digital learning material and starts and completes elements from the course within the digital learning material. This activity results in progress information that is shared with the Learning Management System | Progress information |
...
## Preconditions
  ...
  - License is still active, End date has not passed yet
